...
serve(async (req) => {
  ...
  try {
    ...
    // Email template para administrador - sem espaços extras que possam causar "=20"
...
<body>
  <div class="container">
    ...
    // Template de confirmação sem espaços extras
...
<body>
  <div class="container">
    ...
    <div class="content">
      ...
      <p>Nossa equipe de suporte responderá em até <span class="highlight">24 horas úteis</span>.</p>
