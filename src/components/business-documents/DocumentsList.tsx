...
import { BusinessDocument, BusinessDocumentAttachment } from '@/hooks/use-business-documents';
...
interface DocumentsListProps {
  ...
  fetchAttachments: (id: string) => Promise<BusinessDocumentAttachment[]>;
  currentPage: number;
  totalPages: number;
...
export const DocumentsList: React.FC<DocumentsListProps> = ({
  ...
  const [detailView, setDetailView] = useState<BusinessDocument | null>(null);
