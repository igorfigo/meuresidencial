...
const DashboardLayout: React.FC<DashboardLayoutProps> = ({ children }) => {
  ...
  return (
    <div className="min-h-screen flex w-full bg-gradient-to-br from-gray-50 to-blue-50">
      ...
      <div className="lg:hidden fixed top-0 left-0 right-0 z-50 bg-sidebar text-sidebar-foreground shadow-md flex items-center justify-between px-4 py-3">
        <div className="flex items-center">
          <button
          ...
          <h1 className="text-xl font-semibold truncate max-w-[200px] text-sidebar-foreground">
            {getCurrentPageName()}
          </h1>
        </div>
        <div className="flex items-center space-x-2">
          <NavLink to="/perfil" className="p-2 text-sidebar-foreground hover:text-white transition-colors">
