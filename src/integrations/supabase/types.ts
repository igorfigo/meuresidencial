...
export type Database = {
  public: {
    Tables: {
      ...
      business_admin_document_permissions: {
        Row: {
          created_at: string | null
        ...
        Relationships: [
          {
            foreignKeyName: "business_admin_document_permissions_document_id_fkey"
            columns: ["document_id"]
            isOneToOne: false
            referencedRelation: "business_admin_documents"
            referencedColumns: ["id"]
          },
        ]
      }
      business_admin_documents: {
        Row: {
          created_at: string | null
