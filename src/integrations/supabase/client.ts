...
export const getAnnouncementsByMatricula = async (matricula: string) => {
  ...
  const { data, error } = await supabase
    .rpc('get_announcements_by_matricula', { p_matricula: matricula }) as {
...
export const getAnnouncementAttachments = async (announcementId: string) => {
  ...
  const { data, error } = await supabase
    .rpc('get_announcement_attachments', { p_announcement_id: announcementId }) as {
...
export const createAnnouncement = async (announcementData: any) => {
  ...
  const { data, error } = await supabase
    .rpc('create_announcement', { announcement_data: announcementData }) as {
      data: Announcement[] | null;
      error: any;
    };
...
export const deleteAnnouncement = async (id: string) => {
  ...
  const { data, error } = await supabase
    .rpc('delete_announcement', { p_id: id }) as {
      data: boolean | null;
      error: any;
    };
