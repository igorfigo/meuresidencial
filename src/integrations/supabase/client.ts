...
export const saveFinancialIncome = async (incomeData: any) => {
  try {
    const { id } = incomeData;
    ...
    if (id) {
      ...
      if (error) {
        console.error('Error updating financial income:', error);
        throw error;
      }
      ...
      if (error) {
        console.error('Error creating financial income:', error);
        throw error;
      }
    ...
    console.error('Error in saveFinancialIncome:', error);
    throw error;
  }
};
...
export const saveFinancialExpense = async (expenseData: any) => {
  try {
    ...
    console.error('Error in saveFinancialExpense:', error);
    throw error;
  }
};
