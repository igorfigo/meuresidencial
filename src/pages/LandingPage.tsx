          ...
          <div className="border-t border-gray-800 mt-12 pt-8">
            <div className="flex flex-col space-y-6">
              <div className="flex flex-col">
                ...
                <p className="text-gray-400 text-sm">CNPJ: 60112929000134</p>
              </div>
              ...
              <div className="flex flex-col space-y-2">
                ...
                <div className="flex items-start">
                  <Mail className="h-5 w-5 text-brand-400 mr-2 flex-shrink-0 mt-0.5" />
                  <a href="mailto:contato@meuresidencial.com.br" className="text-gray-400 text-sm hover:text-brand-400 transition-colors">
                    contato@meuresidencial.com.br
                  </a>
                </div>
              </div>
